...
//		$HTTP_SESSION_VARS['username'] = $HTTP_SESSION_VARS['username'];
//		$HTTP_SESSION_VARS['password'] = $HTTP_POST_VARS['passwd'];
		$date = date('m d, Y');
...
<DIV id=menu>
          <script language="JavaScript" src="partner_menu.js"></script>
</DIV>

        <TABLE cellpadding=0 cellspacing=0 border="0" width="100%" height="100%">
          
<tr><td width="78%" ALIGN=CENTER VALIGN=TOP background="picts/background-center.jpg"> 
              <TABLE cellpadding=20 cellspacing=0 border=0 width="80%">
                <tr> 
                  <td ALIGN=LEFT VALIGN=TOP class="just">
<p><span class="title">Welcome 
                      To The Alliance Partner Web Site</span><body></p>
                    
                    <p>This is the partner web site, which hopefully will allow 
                      you to extend your capabilities and grow with us as we extend 
                      our expertise and knowledge base. The resources you will 
                      find here are made available to you as a partner of HCH 
                      Enterprises, LLC. If you find a topic or tool that would 
                      further assist your efforts while engaged in a client effort 
                      please provide your input using the forum BBS or contact 
                      us directly. If you find that there is something that can 
                      be provided to help assist the growth and sales of services 
                      we also look forward to hearing you input. </p>
                    <p>The forms, tools, and templates that are provided are merely 
                      a means to assist you in either a technical or financial 
                      goal. The solution set and services that HCH Enterprises, 
                      LLC has put together are based on providing a simple and 
                      complete solution for small to medium businesses. The combined 
                      expertise of the team is comprised of several decades of 
                      ...
                      dealing with customers and clients while working at large 
                      organizations that when you have a team of experts backing 
                      you up! You really do seem to be larger than you appear. 
                    </p>
...
</TD><TD width="22%" align="center" VALIGN="TOP" BGCOLOR="000000"> <IMG SRC="picts/spacer.gif" HEIGHT="75" WIDTH="250" border="0"><BR> 
...
<BR><BR>
      ...
      <td valign="bottom" height="25"> <TABLE cellpadding=0 cellspacing=0 border=0 width="100%" height="40" bgcolor="#000000" background="picts/bg-topbar.gif">
          <tr>
            <td ALIGN="right" VALIGN="top"> <script language="JavaScript" src="partner_menu.js"></script> 
            </td>
          </tr>
        </table>
