...
<tr><td width="74%" ALIGN=CENTER VALIGN=TOP background="picts/background-center.jpg"> 
              <TABLE cellpadding=20 cellspacing=0 border=0 width="80%">
                <tr> 
                  <td ALIGN=LEFT VALIGN=TOP class="just"><span class="title"> 
                    Log In Below:<BR>
                    </span>
<form name="form2" method="post" action="cplogin.php" target="_blank">
                      <div align="center"> 
...
</TD><TD width="26%" align="center" VALIGN="TOP" BGCOLOR="000000"> <IMG SRC="picts/spacer.gif" HEIGHT="75" WIDTH="250" border="0"><BR> 
