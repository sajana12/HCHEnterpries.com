...
BEGIN
{
  ...
  $postmaster        = 'postmaster@hchenterprisesllc.com';
  @referers          = ('www.hchenterprisesllc.com', 'hchenterprisesllc.com', 'localhost');
  @allow_mail_to     = qw(info@hchenterprisesllc.com);
  @recipients        = ();
  %recipient_alias   = ();
...
From: webmaster@hchenterprisesllc.com
Subject: form submission to HCH Enterprises, LLC
...
BEGIN {
  $script = __PACKAGE__->new(
     DEBUGGING              => $DEBUGGING,
     name_and_version       => 'NMS FormMail 3.08c1',
